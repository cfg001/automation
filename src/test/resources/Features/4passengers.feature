Feature: Sample
  ...
  Scenario: 4passengers
    ...
    And user enters "4" in NoofSeats
    ...
    And user enters "Test" in Lastname_2
    And user enters "John" in Firstname_2
    And user enters "ADT" in PTC_2
    And user enters "Test" in Lastname_3
    And user enters "Tony" in Firstname_3
    And user enters "ADT" in PTC_3
    And user enters "Test" in Lastname_4
    And user enters "Jerry" in Firstname_4
    And user enters "ADT" in PTC_4
    ...
    And user take a screenshot
    Then verify user is on "APIPage" Page
    And user selects id "3" from Pax_select
    And user selects "Male" from Gender_Dropdown
    And user enters "220693" in DateofBirth
    And user jclicks BookServicesButton
    And verify DOCS is displayed
    And user take a screenshot
    Then verify user is on "APIPage" Page
    And user selects id "4" from Pax_select
    And user selects "Male" from Gender_Dropdown
    And user enters "220793" in DateofBirth
    And user jclicks BookServicesButton
    And verify DOCS is displayed
    And user take a screenshot
    And user clicks NextStep_Button
    Then verify user is on "FormOfPaymentPage" Page
    And user perform payment type using Visa_CreditCard
